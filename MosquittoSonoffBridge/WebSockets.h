...
#define WEBSOCKETS_TCP_TIMEOUT    (4000)
...
class WebSockets : public Client {
    protected:
#ifdef __AVR__
        ...
        void clientDisconnect(WSclient_t * client, uint16_t code);
        void clientDisconnect(WSclient_t * client, uint16_t code, char * reason, size_t reasonLen);
        ...
        bool sendFrame(WSclient_t * client, WSopcode_t opcode);
        bool sendFrame(WSclient_t * client, WSopcode_t opcode, uint8_t * payload, size_t length);
        bool sendFrame(WSclient_t * client, WSopcode_t opcode, bool mask);
        bool sendFrame(WSclient_t * client, WSopcode_t opcode, bool mask, bool fin, bool headerToPayload);
        bool sendFrame(WSclient_t * client, WSopcode_t opcode, uint8_t * payload, size_t length, bool mask, bool fin, bool headerToPayload);
        ...
        virtual size_t writeWS(WSclient_t * client, uint8_t *out, size_t n);
        size_t writeWS(WSclient_t * client, const char *out);
